            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark border-bottom shadow-sm mb-3">
                ...
                <main class="flex-fill">
                    <div class="container">
                        ...
                        <hr>
                        <p>
                            A empresa Bluvendas tem como objetivo intermediar anúncios entre o vendedor e comprador na região de Blumenau, sempre optando pela segurança e transparência para nossos clientes com um site seguro e confiável.
                        </p>
                        <p>
                            Somos formados por 3 sócios, Felipe Wilhelm, Kleiton Melo e Nicolas Silva, estudamos a ideia de um site de vendas de veículo e percebemos que era um mercado gigante e com bastante espaço no mercado, desenvolvemos a nossa ideia para ajudar e divulgar seu veículo.
                        </p>
                        <b>
                            Pensou em vender seu veículo pensou Bluvendas!!
                        </b>
                    </div>
                </main>
